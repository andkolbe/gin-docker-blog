...
// this layer manages the communication between the inner and outer layers (Repository and Controller layers)

type PostService struct {
	repository repository.PostReposity
}

// returns the PostService struct instance
func NewPostService(r repository.PostReposity) PostService {
	return PostService{
		repository: r,
	}
}
